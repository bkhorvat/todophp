            ...
            <div class="row">
                        ...
                        <div class="list-group list-group-flush border-bottom scrollarea">
                            ...
                            while($row = $query->fetch(PDO::FETCH_OBJ)) {
                                if($row->id == $id){
                                    echo '
                        <div>
                        <a href="home.php" class="link-secondary"><small>Назад</small></a>
                ...
                <div class="col">
                    <form action="/app/edit task.php" method="post">
                        ...
                        <input type="text" name="title" id="title" placeholder="Заголовок" class="form-control" value="<?php echo "$title";?>">
                        <textarea rows="3" name="description" id="description" placeholder="Описание" class="form-control"><?php echo "$description";?></textarea>
                        <div class="row">
                            <div class="col">
                                <div class="row">
                                    <div class="col">
                                        <label for="dateStart">Дата начала</label>
                                        <input type="date" name="dateStart" id="dateStart" placeholder="Описание" class="form-control" value="<?php echo "$dateStart";?>">
                                    </div>
                                    <div class="col">
                                        <label for="dateStart">Времья начала</label>
                                        <input type="time" name="timeStart" id="timeStart" placeholder="Описание" class="form-control" value="<?php echo "$timeStart";?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="date" name="dateEnd" id="dateEnd" placeholder="Дата конца" class="form-control" value="<?php echo "$dateEnd";?>">
                                    </div>
                                    <div class="col">
                                        <label for="dateEnd">Времья конца</label>
                                        <input type="time" name="timeEnd" id="timeEnd" placeholder="Времья конца" class="form-control" value="<?php echo "$timeEnd";?>">
                                    </div>
                                </div>

                            </div>
                            <button type="submit" name="sendTask" class="w-100 btn btn-lg btn-primary mt-3">Редактировать</button>
                        </div>
                    </form>
                </div>
            </div>
